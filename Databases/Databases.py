'''
Question:
Create a Database. Take input from the user for their First Name, Last Name,
Address, City, State, Zipcode. Add the record to the database. Provide the
user to display the currently saved records, edit current records, delete
current records, and exit the program.
'''
...
submit_btn.grid(row=6, column=0, columnspan=2, padx=10, pady=10, ipadx=109)
...
exit_btn.grid(row=12, column=0, columnspan=2, pady=10, padx=10, ipadx=166)
